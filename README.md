...
Uses requests and BeautifulSoup to extract UI elements (buttons, links, input fields, and forms)

and Saves extracted elements in elements.json.
<br><br>
2.Test Case Generation:

Reads elements.json and generates structured test cases.

and Saves test cases in test_cases.xlsx.
<br><br>
3.Selenium Script Generation:

Converts test cases into Python Selenium scripts for automation testing.

Saves scripts in test_scripts.xlsx.
<br><br><br>
